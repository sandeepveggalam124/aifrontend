  ...
  return (
    ...
    >
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          <Grid item xs={6} sx={{marginTop:"20px"}}>
            ...
            >
              <Option value="dog">Organization</Option>
              <Option value="cat">Candidates</Option>
              <Option value="fish">Resumes</Option>
              <Option value="bird">Total Tests</Option>
            </Select>
          </Grid>
          <Grid item xs={6}>
            <Typography
      ...
      <Box sx={{ width: "100%", marginTop: "20px" }}>
        ...
        <Box sx={{ width: "99%", height: "200%", marginTop: "20px" }}>
          <Grid
            container
            rowSpacing={1}
